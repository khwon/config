# Generated by Powerlevel10k configuration wizard on 2020-07-17 at 01:15 AEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    [[ -z $where ]] && res+="${meta}@${clean}$(git name-rev --name-only --no-undefined --always HEAD | sed 's/^remotes/r/')"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=94
